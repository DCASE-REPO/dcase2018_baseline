...
def train(model_name=None, hparams=None, train_csv_path=None, train_clip_dir=None,
  ...
  print('\nTraining model:{} with hparams:{} and class map:{}'.format(model_name, hparams, class_map))
  ...
  with tf.Graph().as_default():
    ...
    with tf.train.SingularMonitoredSession(hooks=[saver_hook, summary_hook], checkpoint_dir=train_dir) as sess:
